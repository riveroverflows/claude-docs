...
1. [Fundamentals](#chapter-1-fundamentals)
2. [Planning and design](#chapter-2-planning-and-design)
3. [Testing and iteration](#chapter-3-testing-and-iteration)
4. [Distribution and sharing](#chapter-4-distribution-and-sharing)
5. [Patterns and troubleshooting](#chapter-5-patterns-and-troubleshooting)
6. [Resources and references](#chapter-6-resources-and-references)
    1. [Reference A: Quick checklist](#reference-a-quick-checklist)
    2. [Reference B: YAML frontmatter](#reference-b-yaml-frontmatter)
    3. [Reference C: Complete skill examples](#reference-c-complete-skill-examples)
...
_💡 Building standalone skills without MCP? Skip to Planning and Design - you can always return here later._
...
|------------------------------------------------------------------|----------------------------------------------------|
| Connects Claude to your service<br>(Notion, Asana, Linear, etc.) | Teaches Claude how to use your service effectively |
...
_Real example:_ [frontend-design skill](https://github.com/anthropics/skills/tree/main/skills/frontend-design) (also see [skills for docx, pptx, xlsx, and ppt](https://github.com/anthropics/skills/tree/main/skills))
...
`` `references/` `` and link to it. (See [Core Design Principles](https://www.anthropic.com/engineering/equipping-agents-for-the-real-world-with-agent-skills) for how the three-level system works.)
...
**Use when:** Your users need multistep processes in a specific order.
